...
- **PITEST (single class)**: `mvn pitest:mutationCoverage -DtargetClasses=edu.ucsb.cs156.spooler.services.jobs.JobService` - **NEVER CANCEL: Takes ~2 minutes. Set timeout to 180+ seconds.**
